...
const TaskItem = ({ children, ...props }) => (
	<div className="text-xl 3xl:text-4xl 4xl:text-6xl hover:text-red-700 transition-colors duration-75" {...props}>
		{children}
	</div>
);
...
const Logo = ({ className }) => (
	<div className={[ 'flex flex-col items-center', className ].join(' ')}>
		<img className="w-32 3xl:w-56 4xl:w-64 h-16 3xl:h-32 4xl:h-40 mt-6 3xl:mt-12 4xl:mt-20 mb-4 3xl:mb-8" src={require('../../../../assets/Logo/NPCW.svg')} alt="" />
		<div className="font-bold text-2xl 3xl:text-5xl 4xl:text-6xl">Nick Petho</div>
		<div className="font-bold text-xl 3xl:text-4xl 4xl:text-5xl">Coding</div>
	</div>
);
