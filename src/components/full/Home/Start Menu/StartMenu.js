...
function StartMenu({ isOpen }) {
	...
	return (
		<div className="bg-gray-800 absolute bottom-0 flex flex-col w-56 3xl:w-84 4xl:w-144 text-white z-50">
			<div className="bg-gray-Windows10 p-3 3xl:p-5 4xl:p-7 font-bold 3xl:text-3xl 4xl:text-5xl">
				START
			</div>
			<Link to="/aboutMe" className="p-3 3xl:p-4 4xl:p-5 3xl:px-5 4xl:px-6 mt-20 3xl:mt-24 4xl:mt-56 flex hover:bg-gray-Windows10">
			...
			<Link to="/" className="p-2 3xl:p-4 4xl:p-5 3xl:px-5 4xl:px-6 flex hover:bg-gray-Windows10">
