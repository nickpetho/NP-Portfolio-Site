...
import Windows7Logo from '../../../../assets/Icons/Windows7Logo.webp';
		...
		<div className="h-12 3xl:h-20 4xl:h-32 bg-gray-Windows7 flex items-center relative">
			...
			<TaskIcon>
				<a href="https://www.linkedin.com/in/nick-petho-708b1261/" target="_blank" rel="noopener noreferrer" aria-label="Linkedin">
					<img className="h-10 3xl:h-16 4xl:h-24 w-10 3xl:w-16 4xl:w-24 p-1 3xl:p-2 4xl:p-3 mx-1 3xl:mx-2 4xl:mx-3" src={LinkedInLogo} alt="" />
				</a>
			</TaskIcon>
			<TaskIcon>
