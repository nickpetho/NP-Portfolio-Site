	...
	return (
		<div className="h-screen about-page flex flex-col">
			<div className="flex-grow relative">
				<div className="px-6 3xl:px-12 3xl:pt-6 4xl:px-24 space-y-3">
					<h1 className="underline text-6xl 3xl:text-8xl 4xl:text-10xl">About Me</h1>
					<div className="text-4xl 3xl:text-6xl 4xl:text-8xl italic">Nick Petho (nick.petho@gmail.com)</div>
					<div className="text-3xl 3xl:text-5xl 4xl:text-7xl pt-4">
						A web developer with a passion for frontend design and development.
					</div>
					<div className="text-2xl 3xl:text-4xl 4xl:text-6xl">
					...
					<div className="text-2xl 3xl:text-4xl 4xl:text-6xl">Some other interesting things about me:</div>
					<ul className="text-2xl 3xl:text-4xl 4xl:text-6xl">
