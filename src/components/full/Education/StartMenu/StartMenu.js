...
function StartMenu({ isOpen }) {
	...
	return (
		<div className="bg-gray-Windows95 absolute bottom-0 flex flex-col w-56 3xl:w-96 4xl:w-144">
			...
			<Link to="/aboutMe" className="items-center 3xl:text-3xl 4xl:text-5xl p-3 mt-20 3xl:mt-40 4xl:mt-48 flex hover:bg-blue-W95Start hover:text-white">
				<img className="h-6 3xl:h-12 4xl:h-20 w-6 3xl:w-12 4xl:w-20 mr-3 3xl:mr-5 4xl:mr-7" src={MagnifyingGlass} alt="" />
				<div>About Me</div>
			</Link>
			<Link to="/home" className="items-center 3xl:text-3xl 4xl:text-5xl p-3 flex hover:bg-blue-W95Start hover:text-white">
