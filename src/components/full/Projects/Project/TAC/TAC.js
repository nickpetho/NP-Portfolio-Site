	...
	return (
		<MacWindow circleSize={7} title="TAC" closeTo="/projects">
			<div className="px-6 pb-6 h-full flex flex-col space-y-5 overflow-auto">
				...
				<div>
					The Tutoring Assistance Computer or TAC is an all-in-one tutor tracking software solution designed
					to effectively keep track of student and employee information for the Youngstown State University
					Math Assitance Center (MAC). I implemented SASS (CSS pre-processor) for all custom stylesheets and
					was in charge of the frontend design. I worked with two other computer science students on this
					project.
				</div>
				<div class="flex justify-center font-bold text-2xl">
					<div>
						<img
							className="pr-3 pb-3"
							src={require('../../../../../assets/Projects/TAC_Home.jpg')}
							alt=""
						/>
