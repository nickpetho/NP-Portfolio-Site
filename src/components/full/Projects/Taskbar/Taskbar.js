...
const TaskIcon = ({ children, ...props }) => (
	<div className="h-full w-24 flex items-center justify-center px-1 hover:bg-gray-500" {...props}>
		{children}
	</div>
);
...
function Taskbar() {
	return (
		<div className="h-20 bg-gray-MacTaskbar flex rounded-t-md">
			<TaskIcon>
			...
			<TaskIcon>
				<Link to="/aboutMe">
					<img className="h-16 w-16 p-2" src={MagnifyingGlassIcon} alt="" />
				</Link>
			</TaskIcon>
			<TaskIcon>
				<Link to="/home">
